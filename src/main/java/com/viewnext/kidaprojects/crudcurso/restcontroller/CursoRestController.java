 ...
 * 
 * <p>
 * Esta clase define los puntos de entrada de la API para realizar operaciones
 * CRUD en cursos, como obtener todos los cursos, obtener un curso por su
 * código, dar de alta un nuevo curso, actualizar las horas de un curso y
...
public class CursoRestController {
	 ...
	 * @return Una respuesta HTTP con el curso en formato JSON si se encuentra, o un
	 ...
	 * @return Una respuesta HTTP con una lista actualizada de cursos en formato
	 *         JSON.
	 */
	 ...
	 * @return Una respuesta HTTP 200 (OK) si la actualización se completa con
	 *         éxito, o un mensaje de error y un estado HTTP 404 si el curso no se
	 *         encuentra.
	 */
	@PutMapping(value = "curso", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<?> updateHoras(@RequestParam("codigo") String codigo, @RequestParam("horas") String horas) {
		...
		try {
			...
			// Devuelve una respuesta HTTP 200 (OK) si la actualización se completa con
			// éxito
	 ...
	 * @return Una respuesta HTTP con una lista actualizada de cursos en formato
	 *         JSON si la eliminación se completa con éxito, o un mensaje de error y
	 *         un estado HTTP 404 si el curso no se encuentra.
	 */
